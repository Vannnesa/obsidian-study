...
var SpoilersSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(this.containerEl).setName("Show in export").setDesc(
...
// src/main.ts
var SpoilersPlugin = class extends import_obsidian2.Plugin {
  async onload() {
    ...
    const createSpoilerCover = (container, copyText) => {
      ...
      new import_obsidian2.ButtonComponent(toolbar).setIcon("eye").setClass("spoiler-button").setTooltip("Click to reveal").onClick(function(event) {
        event.stopPropagation();
        spoilerCover.toggleAttribute("data-visible");
        container.toggleAttribute("data-spoiler-visible");
      });
      new import_obsidian2.ButtonComponent(toolbar).setIcon("copy").setClass("spoiler-button").setTooltip("Copy to clipboard").onClick(function(event) {
        event.stopPropagation();
        navigator.clipboard.writeText(copyText);
      });
    };
    const createSpoilerContainer = (el) => {
    ...
    this.registerMarkdownCodeBlockProcessor("spoiler-env", (source, el) => {
      const container = createSpoilerContainer(el);
      const env = (0, import_dotenv.parse)(source);
      ...
      for (const [key, value] of Object.entries(env)) {
        ...
        new import_obsidian2.ButtonComponent(keyColumn).setIcon("copy").setClass("spoiler-table-copy").setTooltip("Copy key").onClick(function() {
          navigator.clipboard.writeText(key);
        });
        new import_obsidian2.ButtonComponent(valueColumn).setIcon("copy").setClass("spoiler-table-copy").setTooltip("Copy value").onClick(function() {
